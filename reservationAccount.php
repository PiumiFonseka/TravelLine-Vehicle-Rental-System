...
<body>
    ...
    <div class="navbar">
	  ...
	  <tr>
	  <th class="col1">Reservation_ID</th>
	  <th class="col1">Customer_name</th>
	  ...
	  if($result->num_rows>0){
		  while($row=$result->fetch_assoc()){
			  ...
			  echo"<td><center><button><a href='editReservation.php? 
              rID=$row[Reservation_ID]&
              name=$row[Customer_name]&
              pdate=$row[Pickup_date]&
              ptime=$row[Pickup_time]&
              rdate=$row[Return_date]&
              rtime=$row[Return_time]'>Update</a></button></center>
              </td>";
			  echo"<td><center><button><a href='deleteReservation.php ? rID=$row[Reservation_ID]'>Delete</a></button></center></td><tr>";
